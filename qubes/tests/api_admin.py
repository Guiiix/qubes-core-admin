...
running and private volume snapshots are disabled. Backup will fail!\n'
    ...
    def test_673_vm_volume_disable_snapshots_while_running(self):
        self.vm.volumes = unittest.mock.MagicMock()
        volumes_conf = {
            'keys.return_value': ['root', 'private', 'volatile', 'kernel'],
        }
    ...
    def test_674_vm_volume_re_enable_snapshots_while_running(self):
        self.vm.volumes = unittest.mock.MagicMock()
        volumes_conf = {
            'keys.return_value': ['root', 'private', 'volatile', 'kernel'],
        }
    ...
    def test_675_start_volume_sourcing_running_volume_without_snapshot(self):
        self.vm.volumes = {
    ...
    def test_676_enable_or_disable_snapshots_while_dispvm_running(self):
        self.vm.volumes = unittest.mock.MagicMock()
        volumes_conf = {
            'keys.return_value': ['root', 'private', 'volatile', 'kernel'],
        }
